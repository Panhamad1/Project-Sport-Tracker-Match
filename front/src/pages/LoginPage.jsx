              ...
              <div className="bg-[#0d0d0d] border border-[#2a2a2a] rounded-xl sm:rounded-2xl p-6 sm:p-8 lg:p-10 hover:border-[#3b82f6]/30 transition-all duration-300">
                ...
                <div className="mb-6 sm:mb-8">
                  ...
                  <p className="text-gray-400 text-sm sm:text-base">
                    Access your football dashboard
                  </p>
                </div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-0 items-center">
                    <label className="flex items-center gap-2 text-sm text-gray-400 cursor-pointer">
                      <input
                        ...
                        className="w-4 h-4 bg-[#1a1a1a] border-[#2a2a2a] rounded focus:ring-[#8b5cf6] text-[#8b5cf6]"
                      />
                      Remember me
                    </label>
                    <Link to="/forgot-password" className="text-sm text-[#3b82f6] hover:text-[#60a5fa] transition-colors text-right">
                      Forgot Password?
                    </Link>
                  </div>
